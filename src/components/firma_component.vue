...
export default {
    ...
    methods: {
        ...
        dibujar(){
            ...
            this.ctx.beginPath(); 
            this.ctx.moveTo(this.x0,this.y0); //origen de la linea
            this.ctx.lineTo(x1,y1); //final de la linea
            this.ctx.stroke(); //dibuja la linea

            //Los puntos finales son puntos de origen para mantener continuidad en la linea
            this.x0=x1;
            this.y0=y1;
        }
    },
